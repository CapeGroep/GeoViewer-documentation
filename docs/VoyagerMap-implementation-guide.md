# VoyagerMap Widget Implementation Guide for Mendix
...
![Marker Configuration](img/Marker%20Configuration.png)
...
![Route Configuration](img/Route%20configuration.png)
...
![WMS layer configuration](img/WMS%20Layer%20configuration.png)
...
![Control configuration](img/Control.png)
...
![Dimension Configuration](img/dimension.png)
